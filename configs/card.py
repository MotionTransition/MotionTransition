...
@dataclass
class motion_abs_unet_adagn_style100(
        data.style100_motion_abs,
        model.motion_unet_adagn_xl,
):
    save_dir: str = 'save/unet_adazero_xl_x0_abs_loss1_fp16_clipwd_224'

@dataclass
class motion_abs_style_enc_adagn_style100(
        data.style100_motion_abs,
        model.motion_style_enc_adagn_xl,
):
    save_dir: str = 'save/unet_adazero_xl_x0_abs_loss1_fp16_clipwd_224'

#训练permo数据集unet
@dataclass
class motion_abs_unet_adagn_PerMo(
        data.permo_motion_abs,
        model.motion_unet_adagn_xl,
):
    save_dir: str = 'save/unet_adazero_xl_x0_abs_loss1_fp16_clipwd_224'
