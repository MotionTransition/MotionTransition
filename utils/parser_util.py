...
class DataOptions:
    ...
    only_text: bool = field(
        default=False,
        metadata={"help": "Train permo only with text. "})
...
class TrainingOptions:
    ...
    styenc_dir: str = field(
        default=None,
        metadata={"help": "Path to load checkpoints."})
...
class CondSyntOptions:
    edit_mode: str = field(
        ...
        metadata={
            "choices": ['lower_body', 'benchmark_sparse', 'benchmark_clip', 'pelvis', 'right_wrist', 'random_frames', 'random_joints', 'random', 'gmd_keyframes', 'uncond', 'pelvis_vr', 'pelvis_feet', 'inbetween', 'my_test'],
